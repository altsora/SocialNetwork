...
public final class ErrorUtil {
    ...
    public static ResponseEntity<ServiceResponse<AbstractResponse>> badRequest(String errorDescription) {
    ...
    public static ResponseEntity<ServiceResponse<AbstractResponse>> unauthorized() {
        ErrorResponse errorResponse = ErrorResponse.builder()
