...
public class StorageService {
    ...
    public Map<String, Object> uploadFileResponse(String type, MultipartFile file)
            throws IOException {
        Map<String, Object> cloudinaryUrl;
    ...
    private static File multipartToFile(MultipartFile image) throws IllegalStateException,
            IOException {
